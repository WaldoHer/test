...
import com.begreen.androidecommerce.models.filter_model.get_filters.FilterDetails;
import com.begreen.androidecommerce.models.product_model.GetAllProducts;
import com.begreen.androidecommerce.customs.EndlessRecyclerViewScroll;
import com.begreen.androidecommerce.adapters.ProductAdapter;
import com.begreen.androidecommerce.customs.FilterDialog;
import com.begreen.androidecommerce.models.filter_model.post_filters.PostFilterData;
...
public class Category_Products extends Fragment {
    ...
    private void RequestFilters(int categories_id) {
        Call<FilterData> call = APIClient.getInstance().getFilters(categories_id, ConstantValues.LANGUAGE_ID);
