...
import com.begreen.androidecommerce.activities.Login;
import com.begreen.androidecommerce.adapters.ProductAttributesAdapter;
...
import com.begreen.androidecommerce.models.product_model.Attribute;
import com.begreen.androidecommerce.models.product_model.Image;
import com.begreen.androidecommerce.models.product_model.ProductData;
import com.begreen.androidecommerce.models.product_model.ProductDetails;
...
public class Product_Description extends Fragment {
    ...
    public static void LikeProduct(int productID, String customerID, final Context context, final View view) {
        Call<ProductData> call = APIClient.getInstance().likeProduct(productID, customerID);
        call.enqueue(new Callback<ProductData>() {
            @Override
            public void onResponse(Call<ProductData> call, retrofit2.Response<ProductData> response) {
                // Check if the Response is successful
    ...
    public static void UnlikeProduct(int productID, String customerID, final Context context, final View view) {
        Call<ProductData> call = APIClient.getInstance().unlikeProduct(productID, customerID);
        call.enqueue(new Callback<ProductData>() {
            @Override
            public void onResponse(Call<ProductData> call, retrofit2.Response<ProductData> response) {
                // Check if the Response is successful
