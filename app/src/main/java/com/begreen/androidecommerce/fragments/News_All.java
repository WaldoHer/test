...
import com.begreen.androidecommerce.adapters.NewsListAdapter;
...
import com.begreen.androidecommerce.models.news_model.all_news.NewsDetails;
...
public class News_All extends Fragment {
    ...
    public void RequestAllNews(int pageNumber) {
        ...
        Call<NewsData> call = APIClient.getInstance().getAllNews(
