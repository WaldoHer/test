...
import com.begreen.androidecommerce.adapters.OrdersListAdapter;
...
public class My_Orders extends Fragment {
    ...
    public void RequestMyOrders() {
        ...
        Call<OrderData> call = APIClient.getInstance().getOrders(customerID, ConstantValues.LANGUAGE_ID);
