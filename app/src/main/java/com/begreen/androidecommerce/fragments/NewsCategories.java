...
import com.begreen.androidecommerce.adapters.NewsCategoriesAdapter;
...
import com.begreen.androidecommerce.models.news_model.news_categories.NewsCategoryDetails;
   ...
   private  int pageNo = 0;
    ...
    public void RequestAllNewsCategories(int pageNumber) {
        ...
        Call<NewsCategoryData> call = APIClient.getInstance()
                .allNewsCategories(ConstantValues.LANGUAGE_ID, pageNumber);
